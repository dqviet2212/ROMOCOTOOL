...
%======================================================================%
% Description: This function represents the state-space model of the dynamical system dStates = getSysDynamics(states, controls, sysDynMat)
% @Inputs:
...
u1 = in2(1,:);
t2 = sparse(1.0./M);
dStates = sparse([1,2,3,4],[1,1,1,1],[dq1,dq2,-t2.*(G-u1+C.*dq1),-t2.*(G+C.*dq2)],4,1);
