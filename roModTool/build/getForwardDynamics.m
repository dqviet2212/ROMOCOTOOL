...
t4 = sparse(1.0./t3);
jointAccel = sparse([1,2],[1,1],[t4.*(M2_2.*u1+G2.*M1_2-G1.*M2_2-C1_1.*M2_2.*dq1+C2_1.*M1_2.*dq1-C1_2.*M2_2.*dq2+C2_2.*M1_2.*dq2),-t4.*(M2_1.*u1+G2.*M1_1-G1.*M2_1-C1_1.*M2_1.*dq1+C2_1.*M1_1.*dq1-C1_2.*M2_1.*dq2+C2_2.*M1_1.*dq2)],2,1);
